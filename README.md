...
- **v0.3.1** (18th Jun 2023): feature - export results as CSV files. Added eslint plugin for imports.
- **v0.3.2** (26th Jun 2023): feature - export results as PDF file.
- **v0.3.3** (30th Dec 2023): chore - update formatting, reorganize data source locations, update dependencies
